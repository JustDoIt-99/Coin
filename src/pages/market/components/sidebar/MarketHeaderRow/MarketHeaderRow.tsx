...
import MarketSortedHeaderCell from "@pages/market/components/sidebar/MarketSortedHeaderCell";
import {Header, Name} from "./MarketHeaderRow.styles.ts";
import type {NameType, SortedKey, SortOrder} from "@pages/market/components/sidebar/type.ts";
